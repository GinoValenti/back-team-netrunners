...
//TIENEN QUE CREAR UN USUARIO DE GMAIL PARA SU APP
const { GOOGLE_ID,GOOGLE_REFRESH,GOOGLE_SECRET,GOOGLE_URL,GOOGLE_USER,LINK_DB } = process.env
//TIENEN QUE CREAR UN USUARIO DE GMAIL PARA SU APP
//TIENEN QUE CREAR UN USUARIO DE GMAIL PARA SU APP
//TIENEN QUE CREAR UN USUARIO DE GMAIL PARA SU APP
...
const accountVerificationEmail = async (mailDelNuevoUsuario,codigoCalculadoConCrypto) => {
    ...
    const mailOptions = {
        ...
        html: getEmailBody({ mail:mailDelNuevoUsuario,code:codigoCalculadoConCrypto,host:LINK_DB }) //invoco la funcion que retorna el template string
    }
