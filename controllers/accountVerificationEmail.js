...
function getEmailBody({email, host, code}) {
  ...
  <div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="640" align="center" style="width:640px;">
          <tr>
            <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
        <![endif]--><div style="max-width:640px;margin:0 auto;box-shadow:0px 1px 5px rgba(0,0,0,0.1);border-radius:4px;overflow:hidden"><div style="margin:0px auto;max-width:640px;background:#7289DA url(https://images.squarespace-cdn.com/content/v1/568aef74d82d5e5e38dcafd8/1452115996317-6AMFN7B5BPBPDP8XLD8F/ADVENTURE+HEADER.jpg?format=1000w) top center / cover no-repeat;"><!--[if mso | IE]>
        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:640px;">
          <v:fill origin="0.5, 0" position="0.5,0" type="tile" src="https://images.squarespace-cdn.com/content/v1/568aef74d82d5e5e38dcafd8/1452115996317-6AMFN7B5BPBPDP8XLD8F/ADVENTURE+HEADER.jpg?format=1000w" />
          <v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
        <![endif]--><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:#7289DA url(https://images.squarespace-cdn.com/content/v1/568aef74d82d5e5e38dcafd8/1452115996317-6AMFN7B5BPBPDP8XLD8F/ADVENTURE+HEADER.jpg?format=1000w) top center / cover no-repeat;" align="center" border="0" background="https://preview.ibb.co/evRp56/confirmation_header.png"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:57px;"><!--[if mso | IE]>
        <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:undefined;width:640px;">
        <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;">MyTinerary</div><!--[if mso | IE]>
        </td></tr></table>
  ...
  <p>Welcome to MyTinerary, we're happy to have you here !!</p>
  <p>Next step is verify your email by clicking the button below</p>
  
            </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="center" border="0"><tbody><tr><td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;" align="center" valign="middle" bgcolor="#A62222">
  <!--  TODO URL toevoegen -->
    <a href="${host}/auth/verify/${code}" style="text-decoration:none;line-height:100%;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
              Email Verification
        ...
        Creators GitHub • <a href="https://github.com/GastonZ" style="color:#1EB0F4;text-decoration:none;" target="_blank">Gaston</a> • <a href="https://github.com/GinoValenti" style="color:#1EB0F4;text-decoration:none;" target="_blank">Gino</a>
